...
opt.tiff_path = '/nfs/data3/gergo/JimMarshel20150306/visualStim-004/visualStim-004_Cycle00001_CurrentSettings_Ch2_000001.tif'; %Input data file
opt.data_path = '/nfs/data3/gergo/JimMarshel20150306/TEST0712/data_25_proj_2_mom_test.mat'; %Output preprocessed data
...
opt.spatial_scale = 0.6; % Rescale data spatially
...
opt.src_string = 'Ch2_*'; %in case of loading multiple frames from a directory, look for this substring to load files
...
opt.mom = 3; %Number of moments used
